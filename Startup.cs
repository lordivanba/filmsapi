...
using filmsapi.infrastructure.repositories;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<filmsdbContext>(options =>
                options.UseSqlServer(Configuration.GetConnectionString("Filmsdb")));

            //Interfaces
            services.AddTransient<IFilmSqlRepository, FilmSqlRepository>();
            services.AddTransient<IDirectorSqlRepository, DirectorSqlRepository>();
        }
